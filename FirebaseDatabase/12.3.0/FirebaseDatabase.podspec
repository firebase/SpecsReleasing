...
Simplify your iOS development, grow your user base, and monetize more effectively with Firebase.
  ...
  s.source           =
ebase/firebase-ios-sdk.git',
    :tag => 'CocoaPods-12.3.0'
com/Firebase'

  ios_deployment_target = '15.0'
  osx_deployment_target = '10.0'

  s.swift_version = '5.9'

  s.ios.deployment_target = ios_deploymenvos_deployment_target
  ...
  s.test_spec 'unit' do |unit_tests|
    ...
    unit_tests.source_files = [
      ...
      'FirebaseDatabase/Tests/Unit/Swift/*'ropFake.[mh]',
  ...
  s.test_spec 'integration' do |int_tests|
    ...
    int_tests.source_files = [
      ...
      'SharedTestUtilities/AppCheckFake/*.[mh]RAuthInteropFake.[mh]',
      'SharedTestUtilities/FIRComponentTestUtilities.[mh]',
      'SharedTestUtilities/FIROptionsMock.[mh]',
    ]
